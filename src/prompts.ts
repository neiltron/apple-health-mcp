...
- Do not call enable_logging, disable_logging, truncate_duckdb_logs, write_log, dynamic-SQL query, or json_execute_serialized_sql; those operations are blocked. query_table remains available.
